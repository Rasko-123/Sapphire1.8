...
struct PID {
	...
	UFortWeaponMeleeItemDefinition* ID;
};
...
static void LoadCharacterParts()
{
	...
	StaticLoadObject<UCustomCharacterPart>(L"/Game/Athena/Heroes/Meshes/Bodies/CP_028_Athena_Body.CP_028_Athena_Body"); //01
	StaticLoadObject<UCustomCharacterPart>(L"/Game/Athena/Heroes/Meshes/Heads/F_MED_ASN_Sarah_Head_02_HelmetHair_ATH.F_MED_ASN_Sarah_Head_02_HelmetHair_ATH"); //01
	StaticLoadObject<UCustomCharacterPart>(L"/Game/Accessories/Hats/Mesh/Female_Commando_07.Female_Commando_07"); //01
	StaticLoadObject<UCustomCharacterPart>(L"/Game/Athena/Heroes/Meshes/Bodies/CP_029_Athena_Body_Halloween.CP_029_Athena_Body_Halloween"); //02
	StaticLoadObject<UCustomCharacterPart>(L"/Game/Athena/Heroes/Meshes/Heads/F_Med_HIS_Ramirez_Head_HW01_ATH.F_Med_HIS_Ramirez_Head_HW01_ATH"); //02
	StaticLoadObject<UCustomCharacterPart>(L"/Game/Athena/Heroes/Meshes/Bodies/CP_027_Athena_Body.CP_027_Athena_Body"); //03
	...
	Globals::CharacterParts.push_back({
		FindObjectFast<UCustomCharacterPart>("/Game/Athena/Heroes/Meshes/Heads/F_MED_ASN_Sarah_Head_02_HelmetHair_ATH.F_MED_ASN_Sarah_Head_02_HelmetHair_ATH"),
		FindObjectFast<UCustomCharacterPart>("/Game/Athena/Heroes/Meshes/Bodies/CP_028_Athena_Body.CP_028_Athena_Body"),
		FindObjectFast<UCustomCharacterPart>("/Game/Accessories/Hats/Mesh/Female_Commando_07.Female_Commando_07"),
		});

	//02
	Globals::CharacterParts.push_back({
		FindObjectFast<UCustomCharacterPart>("/Game/Athena/Heroes/Meshes/Heads/F_Med_HIS_Ramirez_Head_HW01_ATH.F_Med_HIS_Ramirez_Head_HW01_ATH"),
		FindObjectFast<UCustomCharacterPart>("/Game/Athena/Heroes/Meshes/Bodies/CP_029_Athena_Body_Halloween.CP_029_Athena_Body_Halloween"),
		nullptr
		});
	...
	Globals::CharacterParts.push_back({
		...
		FindObjectFast<UCustomCharacterPart>("/Game/Athena/Heroes/Meshes/Bodies/CP_027_Athena_Body.CP_027_Athena_Body"),
		nullptr
		});
...
static void LoadPickaxes()
{
	Globals::Pickaxes.push_back({ FindObjectFast<UFortWeaponMeleeItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_HalloweenScythe_Athena_C_T01.WID_Harvest_HalloweenScythe_Athena_C_T01") });
	Globals::Pickaxes.push_back({ FindObjectFast<UFortWeaponMeleeItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_Pickaxe_Athena_C_T01.WID_Harvest_Pickaxe_Athena_C_T01") });
	Globals::Pickaxes.push_back({ FindObjectFast<UFortWeaponMeleeItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_Pickaxe_BoltOn_Athena_C_T01.WID_Harvest_Pickaxe_BoltOn_Athena_C_T01") });
	Globals::Pickaxes.push_back({ FindObjectFast<UFortWeaponMeleeItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_Pickaxe_Deathvalley_Athena_C_T01.WID_Harvest_Pickaxe_Deathvalley_Athena_C_T01") });
	Globals::Pickaxes.push_back({ FindObjectFast<UFortWeaponMeleeItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_Pickaxe_Flamingo_Athena_C_T01.WID_Harvest_Pickaxe_Flamingo_Athena_C_T01") });
	Globals::Pickaxes.push_back({ FindObjectFast<UFortWeaponMeleeItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_Pickaxe_IcePick_Athena_C_T01.WID_Harvest_Pickaxe_IcePick_Athena_C_T01") });
	Globals::Pickaxes.push_back({ FindObjectFast<UFortWeaponMeleeItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_Pickaxe_Lockjaw_Athena_C_T01.WID_Harvest_Pickaxe_Lockjaw_Athena_C_T01") });
	Globals::Pickaxes.push_back({ FindObjectFast<UFortWeaponMeleeItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_Pickaxe_SickleBat_Athena_C_T01.WID_Harvest_Pickaxe_SickleBat_Athena_C_T01") });
	Globals::Pickaxes.push_back({ FindObjectFast<UFortWeaponMeleeItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_Pickaxe_Smiley_Athena_C_T01.WID_Harvest_Pickaxe_Smiley_Athena_C_T01") });
	Globals::Pickaxes.push_back({ FindObjectFast<UFortWeaponMeleeItemDefinition>("/Game/Athena/Items/Weapons/WID_Harvest_Pickaxe_Spikey_Athena_C_T01.WID_Harvest_Pickaxe_Spikey_Athena_C_T01") });
